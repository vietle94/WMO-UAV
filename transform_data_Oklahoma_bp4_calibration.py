...
# %%
dir_in = r"C:\Users\le\OneDrive - Ilmatieteen laitos\WMO-DC\Oklahoma\calibration\mavic2pro_bp4"
...
# Define meta data
operatorID = '049'
airframeID = 'mavic2bp4'
platform_name = 'Mavic 2 bp4'
...
for path in paths[:-1]:
    ...
    data = []
    for file in all_files:
        if ('OPC-BP4' in os.path.basename(file)) | ('GPS' in os.path.basename(file)):
            continue
